...
export const profile = {
  ...
  address: "B-201, KDHAM BLD NO 2, ASHOKVAN, SHIV VALLABH ROAD, BORIVALI WEST, MUMBAI - 62",
  aadhaar: "XXXX XXXX 3671",
  pan: "AXXXX0000X",
  branch: "Malad Church",
  branchAddress: "FLOOR 1, SATVALI TOWERS, MALAD WEST, OPPO GNEXT HOSPITAL, MUMBAI - 92",
  accountType: "Current Account",
  kycStatus: "Verified",
  accountStatus: "Active",
  nominee: "Sachin (Spouse)",
  openedOn: "14 March 2018",
  lastLogin: "Just now · Malad Church",
