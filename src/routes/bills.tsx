          ...
          {step === "confirm" && (
            <div className="p-5">
              ...
              <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground mt-3">
                <ShieldCheck className="w-3.5 h-3.5 text-success" /> Secured by Indian One · 256-bit SSL
              </div>
