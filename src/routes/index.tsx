...
export const Route = createFileRoute("/")({
  component: Dashboard,
  head: () => {
    const url = "https://www.indianone.in/";
    const title = "Dashboard — Indian One Net Banking";
    const desc = "Your Indian One net banking dashboard: account balance, quick actions, recent transactions and bill payments.";
    return {
      meta: [
        { title },
...
function Dashboard() {
  ...
  return (
    <AppLayout>
      <h1 className="sr-only">Dashboard — Indian One Net Banking</h1>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10px] text-white/70 flex items-center gap-2">
                ...
                <span className="hidden sm:flex items-center gap-1"><MapPin className="w-2.5 h-2.5" /> Varanasi</span>
              </div>
            </div>
          </div>
